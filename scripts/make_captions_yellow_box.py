...
def main():
    print(" Generating yellow box captions (3-4 words)...")
    ...
    ass_lines = [
        ...
        # Yellow background box with black text, centered
        "Style: Default,Arial Black,68,&H00000000,&H000000FF,&H00000000,&H0000FFFF,"
    ...
    print(f" Yellow box captions written to: {ASS_OUT}")
